# Generated by Django 2.0.4 on 2018-07-21 07:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_ubigeo_reniec_continente', models.CharField(max_length=2, validators=[django.core.validators.RegexValidator(message='Numero de 1 o 2 digitos', regex='^[0-9]{1,2}$')], verbose_name='Código Ubigeo Continente - RENIEC')),
                ('cod_ubigeo_inei_continente', models.CharField(max_length=2, validators=[django.core.validators.RegexValidator(message='Numero de 1 o 2 digitos', regex='^[0-9]{1,2}$')], verbose_name='Código Ubigeo Continente - INEI')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cod_ubigeo_reniec_localidad', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(message='Numero entre 8 y 10 digitos', regex='^[0-9]{8,10}$')], verbose_name='Código Ubigeo Localidad - RENIEC')),
                ('cod_ubigeo_inei_localidad', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(message='Numero entre 8 y 10 digitos', regex='^[0-9]{8,10}$')], verbose_name='Código Ubigeo Localidad - RENIEC')),
